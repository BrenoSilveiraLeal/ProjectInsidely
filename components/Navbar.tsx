    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link href="/" className="text-xl sm:text-2xl font-bold flex">
          ...
          <div className="flex gap-2 sm:gap-6 items-center">
            ...
            <Link 
              href="/auth/signup" 
              className="px-4 sm:px-6 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg text-xs sm:text-sm font-medium hover:opacity-90 transition hover:shadow-lg hover:shadow-indigo-500/50"
            >
              {t('signup')}
            </Link>
          </div>
